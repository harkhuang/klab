...
#配置需要编译的boost所用的库
set(BUILD_BOOST_LIBS "filesystem,program_options,stacktrace,test,thread,system,regex,timer,chrono")

ExternalProject_Add(libboost
        EXCLUDE_FROM_ALL 1
        URL ${PROJECT_SOURCE_DIR}/tar/boost_1_67_0.tar.gz
        CONFIGURE_COMMAND ./bootstrap.sh threading=multi --with-libraries=${BUILD_BOOST_LIBS}
        BUILD_IN_SOURCE 1
        BUILD_COMMAND ""
